...
func TestHeuristicClassifierClassify(t *testing.T) {
	tests := []struct {
		...
		{
			name:       "indonesian sustainability report",
			pageTexts:  []string{"Laporan Keberlanjutan 2025\nKeberlanjutan Kami"},
			wantType:   DocTypeSustainabilityReport,
			wantLang:   "id",
			wantMinCon: 0.1,
		},
		{
			name:       "english sustainability report",
			pageTexts:  []string{"Sustainability Report 2025\nESG Performance"},
			wantType:   DocTypeSustainabilityReport,
			wantLang:   "en",
			wantMinCon: 0.1,
		},
		{
			name:       "indonesian corporate presentation",
			pageTexts:  []string{"Presentasi Perusahaan\nPaparan Publik 2025"},
			wantType:   DocTypeCorporatePresentation,
			wantLang:   "id",
			wantMinCon: 0.1,
		},
		{
			name:       "english corporate presentation",
			pageTexts:  []string{"FY25 Results\nAnalyst Meeting\nCompany Presentation"},
			wantType:   DocTypeCorporatePresentation,
			wantLang:   "en",
			wantMinCon: 0.1,
		},
		{
			name:       "indonesian annual report",
			pageTexts:  []string{"Laporan Tahunan 2025\nTata Kelola Perusahaan\nIkhtisar Keuangan"},
			wantType:   DocTypeAnnualReport,
			wantLang:   "id",
			wantMinCon: 0.1,
		},
		{
			name:       "english annual report",
			pageTexts:  []string{"Annual Report 2025\nCorporate Governance\nFinancial Highlights"},
			wantType:   DocTypeAnnualReport,
			wantLang:   "en",
			wantMinCon: 0.1,
		},
