			...
			page: pdf.Page{
				...
				Elements: []pdf.TextElement{
					{Text: "Kas", FontName: "Arial", FontSize: 8, Bounds: pdf.Rect{X1: 50, Y1: 500, X2: 70, Y2: 508}},
					{
						...
						FontName: "Arial",
						FontSize: 8,
						Bounds:   pdf.Rect{X1: 200, Y1: 500, X2: 250, Y2: 508},
					},
					{
						Text:     "29,315,878",
						FontName: "Arial",
						FontSize: 8,
						Bounds:   pdf.Rect{X1: 300, Y1: 500, X2: 350, Y2: 508},
					},
					{
						Text:     "Cash",
						FontName: "Arial",
						FontSize: 8,
						Bounds:   pdf.Rect{X1: 450, Y1: 500, X2: 470, Y2: 508},
					},
					{
						Text:     "Dana yang dibatasi",
						FontName: "Arial",
						FontSize: 8,
						Bounds:   pdf.Rect{X1: 50, Y1: 480, X2: 140, Y2: 488},
					},
					...
					{
						Text:     "Restricted funds",
						FontName: "Arial",
						FontSize: 8,
						Bounds:   pdf.Rect{X1: 450, Y1: 480, X2: 520, Y2: 488},
					},
				},
			},
			wantLines: 2,
			...
			page: pdf.Page{
				...
				Elements: []pdf.TextElement{
					...
					},
					{
						...
						FontName: "Arial",
						FontSize: 12,
						Bounds:   pdf.Rect{X1: 58, Y1: 700, X2: 98, Y2: 712},
					},
				},
			},
			wantLines: 1,
